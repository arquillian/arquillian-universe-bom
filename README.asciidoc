...
==== Arquillian Cube Docker Starter

Arquillian Cube Docker Starter is single unified dependency to use Arquillian Cube Docker in standalone mode
...
Documentation: http://arquillian.org/arquillian-kube
...
==== Arquillian Cube OpenShift Starter

Arquillian Cube Openshift Starter is single unified dependency to use Arquillian Cube Openshift in standalone mode
...
Arquillian Cube Kubernetes Starter is single unified dependency to use Arquillian Cube Kubernetes in standalone mode
...
<dependency>
    ...
    <scope>test</scope
    <version>3.5.0-beta.2</version> <!-- any 3.5.X -->
</dependency>
----
...
<dependency>
    ...
    <version>3.4.2</version> <!-- Any 3.X should work -->
    <scope>test</scope>
</dependency>
----
